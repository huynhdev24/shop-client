        ...
        <div className={`navbar ${styles.navbar}`}>
            <div className={styles.navItem}>
                <NavLink to="/" className={({isActive}) => isActive ? `${styles.active}` : null}>
                    <img src={home} style={{width : '20px', height : '20px', marginRight: '2px'}} alt="book" />
                    Trang chủ
                </NavLink>
            </div>
            <div className={styles.navItem}>
                <NavLink to="/san-pham" className={({isActive}) => isActive ? `${styles.active}` : null}>
                    <img src={book} style={{width : '20px', height : '20px', marginRight: '2px'}} alt="book" />
                    Sản phẩm
                </NavLink>
            </div>
            <div className={styles.navItem}>
                <NavLink to="/khuyen-mai" className={({isActive}) => isActive ? `${styles.active}` : null}>
                    <img src={voucher} style={{width : '20px', height : '20px', marginRight: '2px'}} alt="voucher" />
                    Khuyến mãi
                </NavLink>
            </div>
        </div>
